 ...
 * 
 * public ShoppingConfirmAddressPage(WebDriver driver) { super(driver); }
 ...
 * clickOn(PROCEED_TO_CHECKOUT_BUTTON_LOCATOR); ShippingPage shippingPage= new
 * ShippingPage(getDriver()); return shippingPage; }
 * 
 * }
 */